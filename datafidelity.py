...
from Dataloader import Adult,German,Water,Airline,Titanic,Phoneme
...
def eval_df(dataset, ces):
    ...
    if dataset == "adult":
        ...
        _data = Airline()
        weights = {'NB':1, 'DT':1, 'SVM':1, 'MLP':1, 'KNN':1}
        pass
...
if args.data != "airline":
    ...
    d_g = encoder.encode(pd.read_csv(root_path + "dice_r.csv",header=0).iloc[:,:-1])
    pass
